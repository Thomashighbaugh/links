...
export default function LinksList() {
	return (
		<ul className='w-full h-full  gap-y-4 mt-3 flex flex-col flex-wrap sm:flex-row md:flex-row lg:flex-row xl:flex-row -m-2'>
			{links.map((link) => (
				<li
					key={link.text}
					title={link.text}
					tabIndex={0}
					className=' mb-0 sm:mb-0 md:mb-4 px-2 min-w-[28%] sm:mx-0 mx-0 md:mx-4 lg:mx-4 xl:mx-4 rounded bg-accent-primary transition-all duration-200 hover:bg-accent-primary-state hover:-translate-y-2
